...
const CustomOrderSection = () => {
  ...
  const inputClasses =
    "w-full px-4 py-3 bg-background border border-border rounded-lg font-body text-sm sm:text-base text-foreground focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all";
  ...
  return (
    <section id="custom" className="py-16 sm:py-20 md:py-24 px-4 sm:px-6 bg-section-alt">
      <div className="container mx-auto max-w-2xl">
        ...
        >
          <p className="font-body text-xs sm:text-sm uppercase tracking-[0.3em] mb-2 sm:mb-3 text-muted-foreground">
            Made for You
          </p>
        ...
        <motion.form
          ...
          className="rounded-xl p-6 sm:p-8 md:p-10 shadow-warm space-y-5 sm:space-y-6 bg-container-bg/50"
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
            <div>
              <label className="font-body text-xs sm:text-sm block mb-2 text-foreground/70">Your Name</label>
            ...
            <div>
              <label className="font-body text-xs sm:text-sm block mb-2 text-foreground/70">Email</label>
          ...
          <div>
            <label className="font-body text-xs sm:text-sm block mb-2 text-foreground/70">Category</label>
          ...
          <div>
            <label className="font-body text-xs sm:text-sm block mb-2 text-foreground/70">Describe Your Vision</label>
          ...
          <button
            type="submit"
            disabled={submitted}
            className="w-full py-3 sm:py-3.5 bg-primary text-primary-foreground font-body text-xs sm:text-sm uppercase tracking-widest rounded-lg hover:opacity-90 transition-all flex items-center justify-center gap-2 disabled:opacity-70 shadow-warm"
          >
